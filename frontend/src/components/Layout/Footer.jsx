...
const Footer = () => {
  return (
    <div className="bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="flex flex-col items-center justify-center text-center sm:px-12 px-4 bg-gradient-to-r from-teal-600 to-teal-700 py-8">
        <h1 className="lg:text-4xl text-3xl mb-4 lg:leading-normal font-semibold max-w-3xl">
          <span className="text-white">NexMart</span>
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:px-12 px-4 py-16">
        <div className="text-center sm:text-start">
          <div className="flex items-center justify-center sm:justify-start mb-4">
            <h2 className="text-3xl font-bold text-teal-400">NexMart</h2>
          </div>
          ...
          <div className="flex items-center justify-center sm:justify-start space-x-4">
            <div className="p-2 bg-teal-600 rounded-full hover:bg-teal-500 transition-colors cursor-pointer">
        ...
        <div className="text-center sm:text-start">
          <h3 className="text-xl font-semibold text-teal-400 mb-4">Company</h3>
          <ul className="space-y-2">
            {footerProductLinks.map((link, index) => (
              <li key={index}>
                <Link
                  className="text-gray-300 hover:text-teal-400 duration-300 text-sm cursor-pointer leading-6 transition-colors"
                  to={link.link}
                >
                  {link.name}
                </Link>
        ...
        <div className="text-center sm:text-start">
          <h3 className="text-xl font-semibold text-teal-400 mb-4">Shop</h3>
          <ul className="space-y-2">
        ...
        <div className="text-center sm:text-start">
          <h3 className="text-xl font-semibold text-teal-400 mb-4">Support</h3>
          <ul className="space-y-2">
      ...
      <div className="border-t border-gray-800">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-center pt-6 pb-8 px-4 sm:px-12">
          <div className="text-gray-400 text-sm">
            <span>© 2025 NexMart. All rights reserved.</span>
          </div>
