  ...
  return (
    <div className="w-full p-8">
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4">
        {/* Account Balance */}
        <div className="w-full md:w-[30%] min-h-[20vh] bg-white shadow rounded px-4 py-5">
          <div className="flex items-center">
          ...
          <h5 className="pt-2 pl-[36px] text-[22px] font-[500]">${availableBalance}</h5>
          <Link to="/dashboard-withdraw-money">
            <h5 className="pt-4 pl-[36px] text-[#077f9c] cursor-pointer">Withdraw Money</h5>
          </Link>
        </div>
        ...
        <div className="w-full md:w-[30%] min-h-[20vh] bg-white shadow rounded px-4 py-5">
          ...
          <Link to="/dashboard-orders">
            <h5 className="pt-4 pl-[36px] text-[#077f9c] cursor-pointer">View Orders</h5>
          </Link>
        </div>
        ...
        <div className="w-full md:w-[30%] min-h-[20vh] bg-white shadow rounded px-4 py-5">
          ...
          <Link to="/dashboard-products">
            <h5 className="pt-4 pl-[36px] text-[#077f9c] cursor-pointer">View Products</h5>
          </Link>
        </div>
      </div>
